...
sed -i "s/LIBS += -lboost_system-mgw49-mt-s-1_57 -lboost_filesystem-mgw49-mt-s-1_57 -lboost_program_options-mgw49-mt-s-1_57 -lboost_thread-mgw49-mt-s-1_57/LIBS += -lboost_system-mt -lboost_filesystem-mt -lboost_program_options-mt -lboost_thread-mt/g" lizus.pro
sed -i "s/BOOST_LIB_SUFFIX=-mgw49-mt-s-1_57/BOOST_LIB_SUFFIX=-mt/g" lizus.pro
sed -i 's/LIBS += $$join(SECP256K1_LIB_PATH,,-L,) -lsecp256k1/LIBS += $$join(SECP256K1_LIB_PATH,,-L,) -lsecp256k1 -lgmp/g' lizus.pro
